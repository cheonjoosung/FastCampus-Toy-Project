...
import com.example.fastcampus.part2.ch15_weather.widget.WeatherAppWidgetProvider
...
class UpdateWeatherService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            val pendingIntent: PendingIntent = Intent(/* packageContext = */ this, /* cls = */
        ...
        LocationServices.getFusedLocationProviderClient(this).lastLocation.addOnSuccessListener {
            WeatherRepository.callWeather(
                longitude = it?.longitude ?: 126.90514411770405,
                latitude = it?.latitude ?: 37.48814860666663,
